...
<div class="h-20 flex flex-row bg-aa-blue">
    ...
    <div class="flex w-screen justify-center items-center gap-5">
        <a href="" class="flex justify-center items-center h-14 w-36 text-xl bg-aa-dark-blue rounded-2xl text-aa-grey font-bold">Movies</a>
        <a href="" class="flex justify-center items-center h-14 w-36 text-xl bg-aa-dark-blue rounded-2xl text-aa-grey font-bold">Television</a>
