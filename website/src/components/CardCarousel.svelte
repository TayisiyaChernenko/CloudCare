...
<div class="card-carousel">
    ...
    <div class="content" on:mousedown={startDrag} on:mouseup={stopDrag} on:mousemove={handleDrag} on:touchstart={startDrag} on:touchend={stopDrag} on:on:touchmove={handleDrag}>
